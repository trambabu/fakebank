package com.fake.bank.demo.utils;
...
public class Messages {
	...
	// AccountDTO
	public static final String ACCT_NAME_REQ			= "AccountDTO Name is required.";
	public static final String ACCT_TYPE_REQ			= "AccountDTO Type Code is required.";
	public static final String ACCT_TYPE_FORMAT			= "AccountDTO Type Code must either be '" 
	...
	public static final String ACCT_XFER_TO_ACCT_REQ	= "Transfer To AccountDTO is required.";
	public static final String ACCT_CREATE_MSG_FORMAT	= "Successfully created new {0} account named {1}";
	
	// Promotions
	public static final String PROMO_ACCT_TYPE_REQ		= "AccountDTO Type is required";
	...
	// VISA API Service
	public static final String VISA_ACCOUNT_FORMAT		= "AccountDTO number must follow proper account format";
	...
	public static final String OBP_NO_BANK_DETAILS_ACCT	= "Unable to get the details for the banking provider for the selected AccountDTO.";
	...
	public static final String OBP_ACCOUNT_LINKED		= "The AccountDTO selected is already linked to Digital Bank.";
	...
	public static final String CREDIT_APP_EMP_STATUS_FORMAT	= "Employment Status must either be "
															...
															+ "'Student', or "
															+ "'Unemployed'";
	public static final String CREDIT_APP_BANK_STATUS_REQ	= "Bank AccountDTO Status is required.";
	public static final String CREDIT_APP_BANK_STATUS_FORMT = "Bank AccountDTO Status must either be "
