...
public class Constants {
	...
	// AccountDTO Email Info
	public static final String ACCT_OPEN_EMAIL_SUB  = "NEW ACCOUNT OPEN STATUS";
	public static final String ACCT_OPEN_EMAIL_STATUS  = "NEW DEBIT AND CREDIT ACCOUNT's OPEND SUCCESSFULLY";
