...
import com.fake.bank.demo.entity.mapper.Usermapper;
import com.fake.bank.demo.exception.RestInvalidArguementException;
import com.fake.bank.demo.model.Notification;
import com.fake.bank.demo.model.NotificationType;
import com.fake.bank.demo.model.UserProfile;
import com.fake.bank.demo.user.Users;
import com.fake.bank.demo.user.repository.RoleRepository;
import com.fake.bank.demo.user.repository.UserProfileRepository;
import com.fake.bank.demo.user.repository.UserRepository;
import com.fake.bank.demo.user.repository.UserRoleRepository;
...
//	public void createUser(Users newUser, String role) {
	public void createUser(UserDTO newUser, String role) {
	    ...
	    user = usermapper.convertToEntity(newUser, user);
	    
	    UserRole userRole = new UserRole(user, roleRepository.findByName(role));
	    ...
	    boolean status = accountService.createAccounts(debitAccount, creditAccount);  
	    
	    LOG.debug("Create User: New User Created.");
	    LOG.debug("Create Accounts: New Debit and Credit Accounts Created with Status." + status);
